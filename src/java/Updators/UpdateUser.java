...
//            checker
            String checker="SELECT id FROM users WHERE username=? AND user_id!=?";
            ...
            if(conn.rs.next()){
              ...
              String inserter="UPDATE users SET type_id=?,username=?,password=?,link_id=? WHERE user_id=?";
              conn.pst=conn.conn.prepareStatement(inserter);
              conn.pst.setString(1, type_id);
