 ...
 * @author mwamb
 */
public class UpdatePaymentMode extends HttpServlet {
HttpSession session;
String output,mode_id,mode_name;
    ...
    try {
        ...
        Logger.getLogger(UpdatePaymentMode.class.getName()).log(Level.SEVERE, null, ex);
    }
    }
