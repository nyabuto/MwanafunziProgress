 ...
 * @author mwamb
 */
public class NewParentRelationship extends HttpServlet {
HttpSession session;
...
//                record already exist
                  output="Record already exist.";
            }
            else{
//                add as new record
relationship_id=rand.current_id();
                    String inserter="INSERT INTO parent_relationships (relationship_id,relationship_name) VALUES(?,?)";
    ...
    try {
        ...
        Logger.getLogger(NewParentRelationship.class.getName()).log(Level.SEVERE, null, ex);
    }
    }
